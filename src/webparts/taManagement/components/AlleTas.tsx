                ...
                <div className={styles.content}>
                    ...
                    {filtered.length === 0 ? (
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                            <div className={styles.listRow} style={{ background: 'transparent', borderBottom: '1px solid #e2e8f0', color: '#64748b', fontSize: 12, textTransform: 'uppercase', letterSpacing: '0.05em', cursor: 'default', paddingBottom: 8 }}>
                            ...
                            {filtered.map(ta => (
                                ...
                                >
                                    ...
                                    <div style={{ width: 120, flex: 'none', display: 'flex', justifyContent: 'center' }}>
